...
export default {
    ...
    getSearchKey() {
        return new Promise((resolve, reject) => {
            axios.get(`${qqPrefix}/splcloud/fcgi-bin/gethotkey.fcg?g_tk=1928093487&inCharset=utf-8&outCharset=utf-8&notice=0&format=jsonp&uin=0&needNewCode=1&platform=h5`).then(result => {
